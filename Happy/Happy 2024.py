...
# Load data
df = pd.read_csv("add your file location \2024.csv")
df
...
selected_year = st.sidebar.selectbox("Select Year", ["2024"])  # Assuming 2024 data
...
# Footer
st.markdown("---")
st.markdown("Data Source: World Happiness Report 2024 from Kaggle")